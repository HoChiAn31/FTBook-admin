    ...
    useEffect(() => {
        if (isLoading) {
            ...
            const totalRevenue = dataPayment
                .filter((order) => order.orderStatus !== 'Hủy đơn')
