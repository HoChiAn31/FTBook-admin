...
function BookCategoryPage() {
    ...
    const filteredData = dataCategoryAll.filter(
        (category) =>
    ...
    return (
        <div className="p-8">
            ...
            {isSuccess && (
                <>
                    <div className="fixed top-4 right-1 z-[100] w-56 bg-white text-black py-6 px-4 rounded shadow-2xl border-l-4 border-green animate-slide-in-right">
